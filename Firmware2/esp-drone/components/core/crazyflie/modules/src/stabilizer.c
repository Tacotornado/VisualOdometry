...
void stabilizerInit(StateEstimatorType estimator)
{
  ...
  DEBUG_PRINT_LOCAL("State estimator init done");
  controllerInit(ControllerTypeAny);
  DEBUG_PRINT_LOCAL("Controller init done");
  powerDistributionInit();
  DEBUG_PRINT_LOCAL("Power distribution init done");
  sitAwInit();
  DEBUG_PRINT_LOCAL("Sit aw init done");
